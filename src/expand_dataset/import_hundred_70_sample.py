...
# all_scheduling = db.get_all_email_predictions_greater_than_70()
...
#     
# db.create_sample_table("sample_100_email")
# for se in sample_emails:
#     db.insert_sample_email("sample_100_email", se)
all_sample_emails = db.get_sample_emails("sample_100_email")
